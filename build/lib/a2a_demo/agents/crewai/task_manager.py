...
class CrewAITaskManager(InMemoryTaskManager):
    """Task manager for CrewAI agents."""
    
    def __init__(self, agent_type: str = "creative"):
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        ...
        try:
            ...
            # Process with the agent - CrewAI might take a while
